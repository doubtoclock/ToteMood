...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e18]:
    ...
    - generic [ref=f1e33]:
      - generic [ref=f1e34]:
        ...
        - link "CUSTOM GHIBLI ART TOTE BAG ₹499.00 ₹599.00 (142)" [ref=f1e44] [cursor=pointer]:
          - /url: /shop/ghibli-art-tote
          - heading "CUSTOM GHIBLI ART TOTE BAG" [level=3] [ref=f1e46]
          - generic [ref=f1e47]:
            - generic [ref=f1e48]: ₹499.00
            - generic [ref=f1e49]: ₹599.00
  ...
  - contentinfo [ref=f1e284]:
    - generic [ref=f1e285]:
      - generic [ref=f1e286]:
        - generic [ref=f1e287]:
          - link "Totemood" [ref=f1e288] [cursor=pointer]:
            - /url: /
          - paragraph [ref=f1e289]: Personalised canvas tote bags. Every piece tells your story.
        - generic [ref=f1e290]:
          - generic [ref=f1e291]:
            - heading "Shop" [level=4] [ref=f1e292]
            - link "Collections" [ref=f1e293] [cursor=pointer]:
              - /url: /shop
            - link "Custom Totes" [ref=f1e294] [cursor=pointer]:
              - /url: /shop
            - link "Bestsellers" [ref=f1e295] [cursor=pointer]:
              - /url: /shop
          - generic [ref=f1e296]:
            - heading "Company" [level=4] [ref=f1e297]
            - link "About" [ref=f1e298] [cursor=pointer]:
              - /url: /about
            - link "Contact" [ref=f1e299] [cursor=pointer]:
              - /url: /contact
            - link "FAQ" [ref=f1e300] [cursor=pointer]:
              - /url: /#faq
        - generic [ref=f1e301]:
          - heading "Connect" [level=4] [ref=f1e302]
          - link "WhatsApp" [ref=f1e303] [cursor=pointer]:
            - /url: https://wa.me/919890842755
          - link "Instagram" [ref=f1e306] [cursor=pointer]:
            - /url: https://instagram.com/totemood_gifts
      - generic [ref=f1e309]:
        - paragraph [ref=f1e310]: © 2026 Totemood. All rights reserved.
        - paragraph [ref=f1e311]: Mumbai, India
  - generic [ref=f1e312]:
    - link "Chat on WhatsApp" [ref=f1e313] [cursor=pointer]:
      - /url: https://wa.me/919890842755
    - link "Follow on Instagram" [ref=f1e316] [cursor=pointer]:
      - /url: https://instagram.com/totemood_gifts
  - alert [ref=f1e319]
```
