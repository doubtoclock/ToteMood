...
Call log:
  ...
  - waiting for locator('button[aria-label=\'Open menu\']')
    9 × locator resolved to <button aria-label="Open menu" class="hidden ml-2 transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary rounded-sm p-1">…</button>
