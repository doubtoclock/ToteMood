...
- generic [active] [ref=f1e1]:
  ...
  - main [ref=f1e18]:
    ...
    - generic [ref=f1e172]:
      - generic [ref=f1e173]:
        - generic [ref=f1e174]: Frequently Asked Questions
        - heading "Everything you might want to know." [level=2] [ref=f1e175]
      - generic [ref=f1e176]:
        - generic [ref=f1e177]:
          - button "How long will it take to share the design with the customer?" [ref=f1e178]
          - paragraph [ref=f1e182]: The design will be delivered to your WhatsApp for approval within 6 to 8 hours after ordering.
        - generic [ref=f1e183]:
          - button "Will I get to see the design before it is printed?" [ref=f1e184]
          - paragraph [ref=f1e188]: Absolutely yes. Your design will be shared on WhatsApp for approval. We start printing only after you confirm the final design.
        - generic [ref=f1e189]:
          - button "Why don't you offer full Cash on Delivery?" [ref=f1e190]
          - paragraph [ref=f1e194]: Our products are custom-made for you, we don't offer full COD. A small advance confirms your order and allows us to create and share the design for approval. The balance is paid on the delivery.
        - generic [ref=f1e195]:
          - button "Why do I need to pay ₹49 while placing the order?" [ref=f1e196]
          - paragraph [ref=f1e200]: We take a ₹49 advance because this is a custom-made product. It confirms your order and allows us to create and share the design on WhatsApp for approval. The amount is minus in the final payment that you can pay on delivery.
        - generic [ref=f1e201]:
          - button "Is there any return policy?" [ref=f1e202]
          - paragraph [ref=f1e206]: Customized products are non-returnable. Returns or replacements are only applicable for damaged, defective, or wrong items (with unboxing video proof).
        - generic [ref=f1e207]:
          - button "What if I want changes in the design?" [ref=f1e208]
          - paragraph [ref=f1e212]: No worries at all! You can request minor changes during the WhatsApp approval stage, and we'll update the design before final printing.
        - generic [ref=f1e213]:
          - button "How long will it take to receive my order?" [ref=f1e214]
          - paragraph [ref=f1e218]: Once your design is approved, your order is printed and delivered within 4-6 working days.
    - generic [ref=f1e220]:
      - generic [ref=f1e221]:
        - generic:
          - heading "TOTE MOOD" [level=2]:
            - generic: TOTE
            - generic: MOOD
        - img "Totemood Product Mockup" [ref=f1e223]
      - generic [ref=f1e224]:
        - generic [ref=f1e225]:
          - link "Collections" [ref=f1e226] [cursor=pointer]:
            - /url: /shop
          - link "About" [ref=f1e227] [cursor=pointer]:
            - /url: /about
          - link "FAQ" [ref=f1e228] [cursor=pointer]:
            - /url: /#faq
          - link "Contact" [ref=f1e229] [cursor=pointer]:
            - /url: /contact
        - generic [ref=f1e230]:
          - link "WhatsApp" [ref=f1e231] [cursor=pointer]:
            - /url: https://wa.me/919890842755
          - link "Instagram" [ref=f1e232] [cursor=pointer]:
            - /url: https://instagram.com/totemood_gifts
        - generic [ref=f1e233]: © 2026 Totemood. All rights reserved.
  - contentinfo [ref=f1e234]:
    - generic [ref=f1e235]:
      - generic [ref=f1e236]:
        - generic [ref=f1e237]:
          - link "Totemood" [ref=f1e238] [cursor=pointer]:
            - /url: /
          - paragraph [ref=f1e239]: Personalised canvas tote bags. Every piece tells your story.
        - generic [ref=f1e240]:
          - generic [ref=f1e241]:
            - heading "Shop" [level=4] [ref=f1e242]
            - link "Collections" [ref=f1e243] [cursor=pointer]:
              - /url: /shop
            - link "Custom Totes" [ref=f1e244] [cursor=pointer]:
              - /url: /shop
            - link "Bestsellers" [ref=f1e245] [cursor=pointer]:
              - /url: /shop
          - generic [ref=f1e246]:
            - heading "Company" [level=4] [ref=f1e247]
            - link "About" [ref=f1e248] [cursor=pointer]:
              - /url: /about
            - link "Contact" [ref=f1e249] [cursor=pointer]:
              - /url: /contact
            - link "FAQ" [ref=f1e250] [cursor=pointer]:
              - /url: /#faq
        - generic [ref=f1e251]:
          - heading "Connect" [level=4] [ref=f1e252]
          - link "WhatsApp" [ref=f1e253] [cursor=pointer]:
            - /url: https://wa.me/919890842755
          - link "Instagram" [ref=f1e256] [cursor=pointer]:
            - /url: https://instagram.com/totemood_gifts
      - generic [ref=f1e259]:
        - paragraph [ref=f1e260]: © 2026 Totemood. All rights reserved.
        - paragraph [ref=f1e261]: Mumbai, India
  - generic [ref=f1e262]:
    - link "Chat on WhatsApp" [ref=f1e263] [cursor=pointer]:
      - /url: https://wa.me/919890842755
    - link "Follow on Instagram" [ref=f1e266] [cursor=pointer]:
      - /url: https://instagram.com/totemood_gifts
  - alert [ref=f1e269]
```
