...
- Name: cart.spec.ts >> Cart Drawer >> C10 - continue shopping closes drawer
- Location: tests/cart.spec.ts:85:7
...
Call log:
  - waiting for locator('a').filter({ hasText: 'Continue Shopping' }).last()
      ...
      - generic [ref=f1e257]:
        - generic [ref=f1e258]:
          ...
          - generic [ref=f1e260]:
            ...
            - button [ref=f1e264]
        - generic [ref=f1e267]:
          - link "CUSTOM GHIBLI TOTE BAG WITH TEXT CUSTOM GHIBLI TOTE BAG WITH TEXT (215) ₹599.00 ₹749.00" [ref=f1e268] [cursor=pointer]:
            - /url: /shop/ghibli-text-tote
            - img "CUSTOM GHIBLI TOTE BAG WITH TEXT" [ref=f1e270]
            - generic [ref=f1e271]:
              - heading "CUSTOM GHIBLI TOTE BAG WITH TEXT" [level=3] [ref=f1e272]
              - generic [ref=f1e273]: (215)
              - generic [ref=f1e286]:
                - generic [ref=f1e287]: ₹599.00
                - generic [ref=f1e288]: ₹749.00
          - link "CUTE EMOJI WITH GHIBLI TOTE CUTE EMOJI WITH GHIBLI TOTE (89) ₹599.00 ₹719.00" [ref=f1e289] [cursor=pointer]:
            - /url: /shop/emoji-ghibli-tote
            - img "CUTE EMOJI WITH GHIBLI TOTE" [ref=f1e291]
            - generic [ref=f1e292]:
              - heading "CUTE EMOJI WITH GHIBLI TOTE" [level=3] [ref=f1e293]
              - generic [ref=f1e294]: (89)
              - generic [ref=f1e307]:
                - generic [ref=f1e308]: ₹599.00
                - generic [ref=f1e309]: ₹719.00
          - link "POLAROID TOTE BAG POLAROID TOTE BAG (34) ₹499.00 ₹599.00" [ref=f1e310] [cursor=pointer]:
            - /url: /shop/polaroid-tote
            - img "POLAROID TOTE BAG" [ref=f1e312]
            - generic [ref=f1e313]:
              - heading "POLAROID TOTE BAG" [level=3] [ref=f1e314]
              - generic [ref=f1e315]: (34)
              - generic [ref=f1e328]:
                - generic [ref=f1e329]: ₹499.00
                - generic [ref=f1e330]: ₹599.00
          - link "ANY DESIGN TOTE BAG ANY DESIGN TOTE BAG (76) ₹499.00 ₹599.00" [ref=f1e331] [cursor=pointer]:
            - /url: /shop/any-design-tote
            - img "ANY DESIGN TOTE BAG" [ref=f1e333]
            - generic [ref=f1e334]:
              - heading "ANY DESIGN TOTE BAG" [level=3] [ref=f1e335]
              - generic [ref=f1e336]: (76)
              - generic [ref=f1e349]:
                - generic [ref=f1e350]: ₹499.00
                - generic [ref=f1e351]: ₹599.00
  - contentinfo [ref=f1e352]:
    - generic [ref=f1e353]:
      - generic [ref=f1e354]:
        - generic [ref=f1e355]:
          - link "Totemood" [ref=f1e356] [cursor=pointer]:
            - /url: /
          - paragraph [ref=f1e357]: Personalised canvas tote bags. Every piece tells your story.
        - generic [ref=f1e358]:
          - generic [ref=f1e359]:
            - heading "Shop" [level=4] [ref=f1e360]
            - link "Collections" [ref=f1e361] [cursor=pointer]:
              - /url: /shop
            - link "Custom Totes" [ref=f1e362] [cursor=pointer]:
              - /url: /shop
            - link "Bestsellers" [ref=f1e363] [cursor=pointer]:
              - /url: /shop
          - generic [ref=f1e364]:
            - heading "Company" [level=4] [ref=f1e365]
            - link "About" [ref=f1e366] [cursor=pointer]:
              - /url: /about
            - link "Contact" [ref=f1e367] [cursor=pointer]:
              - /url: /contact
            - link "FAQ" [ref=f1e368] [cursor=pointer]:
              - /url: /#faq
        - generic [ref=f1e369]:
          - heading "Connect" [level=4] [ref=f1e370]
          - link "WhatsApp" [ref=f1e371] [cursor=pointer]:
            - /url: https://wa.me/919890842755
          - link "Instagram" [ref=f1e374] [cursor=pointer]:
            - /url: https://instagram.com/totemood_gifts
      - generic [ref=f1e377]:
        - paragraph [ref=f1e378]: © 2026 Totemood. All rights reserved.
        - paragraph [ref=f1e379]: Mumbai, India
  - generic [ref=f1e380]:
    - link "Chat on WhatsApp" [ref=f1e381] [cursor=pointer]:
      - /url: https://wa.me/919890842755
    - link "Follow on Instagram" [ref=f1e384] [cursor=pointer]:
      - /url: https://instagram.com/totemood_gifts
  - alert [ref=f1e387]
```
