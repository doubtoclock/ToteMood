...
Call log:
  - waiting for locator('button[aria-label^=\'Remove\']').first()
    - locator resolved to <button aria-label="Remove CUSTOM GHIBLI ART TOTE BAG" class="text-[#8C867C] hover:text-[#b06161] transition-colors p-1">…</button>
  ...
  18 × retrying click action
       ...
       - done scrolling
       - <div class="flex justify-between items-start gap-2">…</div> intercepts pointer events
     - retrying click action
       - waiting 500ms
       - waiting for element to be visible, enabled and stable
       - element is visible, enabled and stable
